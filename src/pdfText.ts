...
/** Gap larger than this fraction of font height becomes a space. */
const SPACE_GAP_FACTOR = 0.15;

/** Y delta larger than this fraction of font height starts a new line. */
const LINE_Y_FACTOR = 0.5;
...
type PdfjsPage = {
    getTextContent: () => Promise<{ items: Array<PdfjsTextContentItem | { type: string }> }>;
};
